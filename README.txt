...
tomo-rename.py - rename tomography images aquired in serial em, replace square brackets with '_' fix -0.0 tilt notation.  Standardize naming convention to:
...
tomo-stacker.py - make stacks from individual tomogram images
